...
<head>
    ...
    <script src="/images/js/jquery/jquery.sparkline.min.js"></script>
    <script src="/images/js/jquery/fullcalendar.min.js"></script>
                            ...
                            <ul class="recent-posts">
                                <li>
                                    <div class="user-thumb">
                                        <img width="40" height="40" alt="User" src="/unicorn/style/images/demo/av2.jpg">
                                    </div>
                                ...
                                <li>
                                    <div class="user-thumb">
                                        <img width="40" height="40" alt="User" src="/unicorn/style/images/demo/av3.jpg">
                                    </div>
                                    <div class="article-post">
                                ...
                                <li>
                                    <div class="user-thumb">
                                        <img width="40" height="40" alt="User" src="/unicorn/style/images/demo/av1.jpg">
                                    </div>
                                    <div class="article-post">
