...
<@easyfkSetAppMenu menuName="EASYFK_MENU" focusItemIds="{['menuPartygLogs','menuPartygLogs_2']}" location="component://party/webapp/party/resources/page/appmenus.ftl">
</@easyfkSetAppMenu>
...
<@easyfkFooterAttach>
<script src="/party/js/oploglist.js"></script>
</@easyfkFooterAttach>
