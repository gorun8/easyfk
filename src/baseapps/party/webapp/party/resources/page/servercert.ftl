...
<@easyfkSetAppMenu menuName="EASYFK_MENU" focusItemIds="{['menuPartygCert','menuPartygCert_1']}" location="component://party/webapp/party/resources/page/appmenus.ftl">
</@easyfkSetAppMenu>
...
<@easyfkFooterAttach>
<script src="/party/js/servercert.js"></script>
</@easyfkFooterAttach>
