...
<@easyfkSetAppMenu menuName="EASYFK_MENU" focusItemIds="{['menuPartygCommunite','menuPartygCommunite_4']}" location="component://party/webapp/party/resources/page/appmenus.ftl">
</@easyfkSetAppMenu>

<@easyfkSetNavBar subTitle="发件箱">
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="alert">
                            <div class="btn-group " style="float: right">
                                ...
                                <ul class="dropdown-menu  pull-right">
                                    <li><a href="#" onclick="easyfk.showMessageDetail()">重新发送</a></li>
                                    <li class="divider"></li>
                                    <li><a href="#" onclick="easyfk.removemsg(1)">删除</a></li>
                                </ul>
                            </div>
                            <strong>张三</strong><p></p> 这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息....
                        </div>
                        <div class="alert alert-success">
                            ...
                            <strong>王二</strong><p></p> 这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息....
                        ...
                        <div class="alert alert-info">
                            ...
                            <strong>李四</strong><p></p> 这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息....
                        ...
                        <div class="alert alert-error">
                            ...
                            <strong>王五</strong><p></p>这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息....
            ...
            <div class="control-group">
                <div class="controls" style="width: 60px;margin-left:-5px;">
                    <div style="height: 300px;" >
                        <textarea style="height: 300px;width: 525px;" >这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息,这是我发出的信息....
                              </textarea>
                    </div>
                </div>
            </div>
