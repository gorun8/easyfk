...
<@easyfkSetAppMenu menuName="EASYFK_MENU" focusItemIds="{['menuPartygLogs','menuPartygLogs_0']}" location="component://party/webapp/party/resources/page/appmenus.ftl">
</@easyfkSetAppMenu>
...
<@easyfkHeaderAttach>
<script src="/static/js/jquery/excanvas.min.js"></script>
<script src="/static/js/jquery/jquery.flot.min.js"></script>
<script src="/static/js/jquery/jquery.flot.pie.min.js"></script>
<script src="/static/js/jquery/jquery.flot.resize.min.js"></script>
</@easyfkHeaderAttach>
<@easyfkFooterAttach>
