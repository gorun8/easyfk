...
<@easyfkSetAppMenu menuName="EASYFK_MENU" focusItemIds="{['menuPartygSetting','menuPartygSetting_1']}" location="component://party/webapp/party/resources/page/appmenus.ftl">
</@easyfkSetAppMenu>
