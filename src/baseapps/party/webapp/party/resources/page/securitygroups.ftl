...
<div class="row">
    <div class="col-xs-12 col-sm-12">
        <@easyfkContextMenu >
            {MENU_DATA:[
            {id:'',title:'新建角色',desc:'新建自定义角色',toggle:'modal',href:'javascript:easyfk.newSecurityGroup()',style:'btn btn-primary tip-bottom',style2:' icon-map-marker icon-white'},
            ]}
        </@easyfkContextMenu>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <#if "Y" == group.isSystem?default("")>
                                    <span class="label label-success">系统角色</span>
                                <#else>
                                    <span class="label label-info">自定义角色</span>
                                </#if>
                            </td>
                            <td>
                            ...
                            <#if "Y" != group.isSystem?default("")>
                                        <li><a href="#" onclick="easyfk.removeSecurityGroup('${group.groupId}')">删除</a></li>
                            </#if>
                                        <li class="divider"></li>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle">操作 <span class="caret"></span></button>
                                <ul class="dropdown-menu  pull-right">
                                    <li><a href="#" onclick="easyfk.editSecurityGroup()"><i class="fa fa-eye"></i>修改</a></li>
                                    <li><a href="#" onclick="easyfk.removeSecurityGroup()">删除</a></li>
                                     
                                    <li class="divider"></li>
                                    <li><a href="#" onclick="easyfk.setGroupPermission(1)"><i class="fa fa-eye"></i>资源</a></li>
                                    <li><a href="#" onclick="easyfk.showUserLogin(1)"><i class="fa fa-eye"></i>关联账号</a></li>
                                    <li class="divider"></li>
                                    <li><a href="#" onclick="easyfk.showLog()"><i class="fa fa-eye"></i>关联日志</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 col-md-4 col-lg-3 control-label">角色</label>
...
<script type="text/javascript">
    ...
    easyfk.setGroupPermission = function (groupId) {
        easyfk.renderGroupPermissionTree("securityResourceTree",groupId,function(){
            $("#groupPermissionAction").val("${ctx}/security/setGroupPermission");
