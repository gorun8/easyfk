...
<@easyfkSetAppMenu menuName="EASYFK_MENU" focusItemIds="{['menuPartygVersion','menuPartygVersion_1']}" location="component://party/webapp/party/resources/page/appmenus.ftl">
</@easyfkSetAppMenu>
