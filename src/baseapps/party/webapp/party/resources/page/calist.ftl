...
<@easyfkSetAppMenu menuName="EASYFK_MENU" focusItemIds="{['menuPartygCert','menuPartygCert_2']}" location="component://party/webapp/party/resources/page/appmenus.ftl">
</@easyfkSetAppMenu>
...
<@easyfkFooterAttach>
<script src="/party/js/calist.js"></script>
</@easyfkFooterAttach>
...
<div class="row-fluid">
    <div class="span12">
        <@easyfkContextMenu  >
            {MENU_DATA:[
            {id:'',title:'添加CA证书',desc:'导入新的CA证书',toggle:'modal',href:'javascript:easyfk.setCACert()',style:'btn btn-primary tip-bottom',style2:' icon-map-marker icon-white'},
            ]}
        </@easyfkContextMenu>
