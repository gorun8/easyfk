...
<@easyfkSetAppMenu menuName="EASYFK_MENU" focusItemIds="{['menuPartygpgs','menuPartygpgs2']}" location="component://party/webapp/party/resources/page/appmenus.ftl">
</@easyfkSetAppMenu>

<@easyfkSetNavBar subTitle="三员列表">
...
<@easyfkFooterAttach>
<script src="/party/js/adminpartylist.js"></script>
</@easyfkFooterAttach>
...
<script type="text/javascript">
    easyfk.partydetial = function(partyId){
        document.location.href = "${ctx}/dyn/party/partydetial?id="+partyId;
    }

    easyfk.showLog = function(){
        document.location.href = "${ctx}/dyn/page/oploglist.ftl";
    }
    ...
    easyfk.newUserLogin = function () {
        $("#userLoginFormAction").val("${ctx}/dyn/party/createuserlogin");
