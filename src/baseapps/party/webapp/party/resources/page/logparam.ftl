...
<@easyfkSetAppMenu menuName="EASYFK_MENU" focusItemIds="{['menuPartygSetting','menuPartygSetting_3']}" location="component://party/webapp/party/resources/page/appmenus.ftl">
</@easyfkSetAppMenu>
