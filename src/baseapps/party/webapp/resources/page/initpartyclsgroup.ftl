    ...
    <div class="span12">
        ...
        <div  style="text-align: center">
            <div   style="overflow-y: auto;height: 550px;">
                <@easyfkContextMenu  >
                    {MENU_DATA:[
                    {id:'',title:'新建最高级的组织机构',desc:'新建最高级的组织机构',toggle:'modal',href:'javascript:easyfk.newOrgNode()',style:'btn btn-large btn-primary tip-bottom',style2:'   icon-wrench icon-white'},
                    ]}
                </@easyfkContextMenu>
            </div>
        </div>
