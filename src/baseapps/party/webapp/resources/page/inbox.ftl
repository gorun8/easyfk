...
<@easyfkSetAppMenu menuName="EASYFK_MENU" focusItemIds="{['menuPartygCommunite','menuPartygCommunite_0']}" location="component://party/webapp/resources/page/appmenus.ftl">
</@easyfkSetAppMenu>
