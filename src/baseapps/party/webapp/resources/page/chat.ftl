...
<@easyfkSetAppMenu menuName="EASYFK_MENU" focusItemIds="{['menuPartygCommunite','menuPartygCommunite_6']}" location="component://party/webapp/resources/page/appmenus.ftl">
</@easyfkSetAppMenu>
