...
$(document).ready(function(){
	...
	$('.chat-message button').click(function(){
		...
		if(input.val() != ''){
			add_message('我说:','/unicorn/style/images/demo/av1.jpg',input.val(),true);
		}
	});
	...
	$('.chat-message input').keypress(function(e){
		if(e.which == 13) {
			if($(this).val() != ''){
				add_message('我说:','/unicorn/style/images/demo/av1.jpg',$(this).val(),true);
			}
		}
	});

	setTimeout(function(){
		add_message('张三','/unicorn/style/images/demo/av2.jpg','我有个问题，什么时候。。。')
	},'6000');
	setTimeout(function(){
		add_message('李四','/unicorn/style/images/demo/av3.jpg','快关闭电脑，准备下班了')
	},'11000');
	setTimeout(function(){
	...
	function remove_user(userid,name) {
		...
		var  inner = $('#chat-messages-inner');
		var id = 'msg-'+i;
		inner.append('<p class="offline" id="'+id+'"><span>'+name+' 已经离开</span></p>');
		$('#'+id).hide().fadeIn(800);
	}
});
