...
import cn.gorun8.easyfk.base.component.ComponentLoaderConfig;
 ...
 * <p/>
 * Example easyfk-application.xml configuration:
 * <pre>
 *   <container name="component-container" class="cn.gorun8.easyfk.base.component.ComponentContainer"/>
 * </pre>
 */
public class ComponentContainer implements Container {
    ...
    public void init(String[] args, String configFile) throws ContainerException {
        ...
        if (cc.getProperty("easyfk.instrumenterClassName") != null) {
            instrumenterClassName = cc.getProperty("easyfk.instrumenterClassName").value;
        } else {
            instrumenterClassName = null;
        }
        if (cc.getProperty("easyfk.instrumenterFile") != null) {
            instrumenterFile = cc.getProperty("easyfk.instrumenterFile").value;
        } else {
    ...
    public synchronized void loadComponents(String loaderConfig, boolean updateClasspath, String instrumenterClassName, String instrumenterFile) throws AlreadyLoadedException, ComponentException {
        ...
        String parentPath;
        try {
            parentPath = FileUtil.getFile(System.getProperty("easyfk.home")).getCanonicalFile().toString().replaceAll("\\\\", "/");
                ...
                for (String sub: fileNames) {
                    try {
                        ...
                        if (componentPath.isDirectory() && !sub.equals("CVS") && !sub.equals(".svn")) {
                            ...
                            File configFile = FileUtil.getFile(componentLocation + "/easyfk-application.xml");
