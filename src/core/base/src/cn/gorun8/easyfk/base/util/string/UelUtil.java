...
import cn.gorun8.easyfk.base.util.collections.LocalizedMap;
...
public class UelUtil {
    ...
    /** Custom <code>ListELResolver</code> used to handle EasyFK
    ...
    /** Prepares an expression for evaluation by UEL.<p>The EasyFK syntax is
