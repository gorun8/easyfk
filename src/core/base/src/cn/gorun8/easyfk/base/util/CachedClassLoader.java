...
public class CachedClassLoader extends URLClassLoader {
    ...
    static {
        ...
        // setup EasyFK classes
        registerClass(cn.gorun8.easyfk.base.util.TimeDuration.class);
    ...
    public String toString() {
        return "cn.gorun8.easyfk.base.util.CachedClassLoader(" + contextName + ") / " + getParent().toString();
    }
    ...
    protected boolean isGlobalPath(String name) {
        ...
        if (name.startsWith("cn.gorun8.easyfk.")) return true;
        return false;
    }
}
