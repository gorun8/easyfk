 ...
 * <p/>
 * menuName :可选的，可以为任意字符，但必须与模板中引用该菜单数据时的名称相同。如果没有设置，默认为EASYFK_MENU.
 * focusItemIds:可选的，当前焦点的菜单ID列表，多个ID用JSON数组管理。
 * 如：focusItemIds= "{[id1,id2,id3]}"
 * 如果设置了，其值将设置于EASYFK_MENU_FOCUS_IDS中。
 * location：可选的，指定模板文件
 * 用法二：
 ...
 */
public class SetAppMenuDirective implements TemplateDirectiveModel {
    public static final String module = SetAppMenuDirective.class.getName();
    public static final String DEFAULT_EASYFK_MENU_NAME = "EASYFK_MENU";
    public static final String EASYFK_MENU_FOCUS_IDS = "EASYFK_MENU_FOCUS_IDS";
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        String location = "";
        String menuName = DEFAULT_EASYFK_MENU_NAME;
        String focusItemIds = "";
        ...
        if (UtilValidate.isNotEmpty(location)){
            ...
            try {
                ...
                request.setAttribute(EASYFK_MENU_FOCUS_IDS, focusItemIds);
            }catch (Exception e){
