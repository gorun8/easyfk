...
/**
 * 头部附加内容
 * 该指令用于设置需要加入到<head></head>部分的内容，一般用于指定
 * js脚本，css等。
 * 可以同时使用引用外部文件和本地内容，如
 * <@easyfkHeaderAttach location="component://sss/sss.js">
 *    <script >
 *    ....
 *    </script>
 * </@easyfkHeaderAttach>
...
public class HeaderAttachDirective implements TemplateDirectiveModel {
    public static final String module = HeaderAttachDirective.class.getName();
    public static final String EASYFK_HEADER_ATTACH = "EASYFK_HEADER_ATTACH";
    ...
    public void execute(Environment env, Map params, TemplateModel[] loopVars,
        ...
        request.setAttribute(EASYFK_HEADER_ATTACH, buffer.toString());
    }
}
