 ...
 * 用法一
 * <p/>
 * <@easyfkContextMenu menuName="..."  focusItemIds= "..." location="component://...." menuStyle="Default"/>
 * <p/>
 ...
 * location：可选的，指定模板文件
 * menuStyle:风格，可以指定菜单的风格。默认为Default.其值没置于EASYFK_MENU_STYLE中。是否有效，由风格模板决定。
 * 系统默认支持Default 和Dropdown两种。
 * 用法二：
 * <@easyfkContextMenu menuName="..." focusItemIds= "..." >
 * 菜单数据
 * </@easyfkSetAppMenu>
...
public class ContextMenuDirective extends AbstractDirective {
	public static final String module = ContextMenuDirective.class.getName();
	...
	public static final String EASYFK_MENU_STYLE = "EASYFK_MENU_STYLE";


	public ContextMenuDirective() {
		super(ThemePart.VT_CONTEXT_MENU_LOC);
	}
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		initMenu(env,params,loopVars, body);
	...
	public void initMenu(Environment env, Map params, TemplateModel[] loopVars,
						TemplateDirectiveBody body) throws TemplateException, IOException {
		Writer out = env.getOut();
		BeanModel req = (BeanModel) env.getVariable("httpServletRequest");
		Object wrappedObject = req.getWrappedObject();
		...
		SimpleScalar menuStyleObject = (SimpleScalar) params.get("menuStyle");
		...
		if(menuStyleObject != null) {
			menuStyle = menuStyleObject.getAsString();
		}//endif
		request.setAttribute(EASYFK_MENU_STYLE, menuStyle);
