...
package cn.gorun8.easyfk.service.dao.impl;
...
import cn.gorun8.easyfk.service.dao.DemoReadDao;
 ...
 */
@Repository("serviceDemoReadDao")
public   class DemoReadDaoImpl extends DemoReadDao {
    private static final String module = DemoReadDaoImpl.class.getName();

    /**
     * 获取XX列表
     * @return
     */
    public   List<GenericValue> findXXList(@Param("param") String id) throws GenericEntityException{
        GenericValue param = new GenericValue();
        param.setString("id",id);
        return this.findList("findXXList",param);
    }
