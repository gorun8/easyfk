...
import cn.gorun8.easyfk.base.container.ClassLoaderContainer;
import cn.gorun8.easyfk.base.container.Container;
import cn.gorun8.easyfk.base.container.ContainerConfig;
import cn.gorun8.easyfk.base.container.ContainerConfig.Container.Property;
import cn.gorun8.easyfk.base.container.ContainerException;
...
public class CatalinaContainer implements Container {
    ...
    public static final String CATALINA_HOSTS_HOME = System.getProperty("easyfk.home") + "/core/catalina/hosts";
    public static final String J2EE_SERVER = "EasyFK Container 3.1";
    public static final String J2EE_APP = "EasyFK";
    ...
    protected boolean     runSetupMode = false;
    protected String   	enableAppList = null;
    protected String   	disableAppList  = null;
    ...
    public void init(String[] args, String configFile) throws ContainerException {
        ...
        this.runSetupMode = ContainerConfig.getPropertyValue(cc, "run-setup-mode", false);
        if(runSetupMode)
        {
        	this.enableAppList = ContainerConfig.getPropertyValue(cc, "enable-app-list", "install");
        } 
        
        this.disableAppList = ContainerConfig.getPropertyValue(cc, "disable-appname", "");
        ...
        // set catalina_home
        System.setProperty(Globals.CATALINA_HOME_PROP, System.getProperty("easyfk.home") + "/" + this.catalinaRuntimeHome);
        ...
        tomcat = new Tomcat();
        tomcat.setBaseDir(System.getProperty("easyfk.home"));
        if (useNaming) {
            tomcat.enableNaming();
        }
    ...
    protected Engine createEngine(ContainerConfig.Container.Property engineConfig) throws ContainerException {
        ...
        if (logDir != null) {
            ...
            if (!logDir.startsWith("/")) {
                logDir = System.getProperty("easyfk.home") + "/" + logDir;
            }
    ...
    protected void loadComponents() throws ContainerException {
        if (tomcat == null) {
            throw new ContainerException("Cannot load web baseapps without Tomcat instance!");
        }
         
        // load the baseapps
        List<ComponentConfig.WebappInfo> webResourceInfos = ComponentConfig.getAllWebappResourceInfos(this.enableAppList);
        ...
        try {
            ...
            for (int i = webResourceInfos.size(); i > 0; i--) {
                ...
                if(disableAppList.indexOf(appInfo.name) >= 0)
                {
                	continue;
                }
