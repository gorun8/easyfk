...
public abstract class CommonReadDao extends ReadDaoBase {
    private static final String module = CommonReadDao.class.getName();

    public CommonReadDao() {
        super("cn.gorun8.easyfk.common.dao.CommonReadDao");
    }
     ...
     * @return
     */
    public abstract GenericValue findStatusValidChange(@Param("status") GenericValue status) throws GenericEntityException;
}
