...
import cn.gorun8.easyfk.common.dao.PortletWriteDao;
...
@Repository
public abstract class PortletWriteDaoImpl extends PortletWriteDao {
    private static final String module = PortletWriteDaoImpl.class.getName();
