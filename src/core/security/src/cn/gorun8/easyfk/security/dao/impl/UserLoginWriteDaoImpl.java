...
@Repository
public class UserLoginWriteDaoImpl extends UserLoginWriteDao {

    @Override
    public void saveUserLogin(@Param("userLogin") GenericValue userLogin) throws GenericEntityException {
        this.store("saveUserLogin",userLogin);
    }
}
