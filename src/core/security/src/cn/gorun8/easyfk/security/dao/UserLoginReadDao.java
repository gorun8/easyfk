...
public abstract class UserLoginReadDao extends ReadDaoBase {
	private static final String module = UserLoginReadDao.class.getName();

	public UserLoginReadDao(){
		super("cn.gorun8.easyfk.security.dao.UserLoginReadDao");
	}
	 ...
	 * @return
	 */
	public abstract List<GenericValue> findUserLoginByPartyId(@Param("params") GenericValue params)throws GenericEntityException;
	}
